...
4. Создай метод public void removeVegetable(int index) - который удаляет из vegetables элемент с
 индексом index.
...
7. Метод addVegetable(int index, String vegetable) должен добавлять параметр vegetable в лист
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        garden.addFruit(0, "Яблоко");
        garden.addVegetable(0, "Морковь");
        garden.removeFruit(0);
